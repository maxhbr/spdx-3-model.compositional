...
instance ToJSON Actor where
    toJSON (Actor name actorType) = object [ "name" .= name
                                           , "actorType" .= actorType
                                           ]
...
instance ToJSON CreationInfo where
    toJSON c = object [ "specVer" .= _specVer c
                      , "profile" .= _profile c
                      , "created" .= _created c
...
mkCreationInfo' actors created = CreationInfo "3.0.0" ["core", "software", "licensing"] created CC0 actors
